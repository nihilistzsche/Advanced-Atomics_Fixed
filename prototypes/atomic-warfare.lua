data:extend(
  {
    ...
    type = "combat-robot",
    name = "nukebot",
    icon = "__Advanced-Atomics_Fixed__/graphics/icons/nukebot.png",
    icon_size = 32,
...
--[[
    ...
    idle =
    {
      ...
      {
        {
          filename = "__Advanced-Atomics_Fixed__/graphics/entity/nukebot/nukebot.png",
          priority = "high",
          line_length = 32,
          width = 64,
          height = 52,
          ...
          hr_version = {
            filename = "__Advanced-Atomics_Fixed__/graphics/entity/nukebot/hr-nukebot.png",
            priority = "high",
            line_length = 32,
            width = 128,
            height = 104,
        ...
        {
          filename = "__Advanced-Atomics_Fixed__/graphics/entity/nukebot/nukebot_mask.png",
          priority = "high",
          line_length = 32,
          width = 64,
          height = 52,
          ...
          hr_version = {
            filename = "__Advanced-Atomics_Fixed__/graphics/entity/nukebot/hr-nukebot_mask.png",
            priority = "high",
            line_length = 32,
            width = 128,
            height = 104,
    ...
    shadow_idle =
    {
      filename = "__Advanced-Atomics_Fixed__/graphics/entity/nukebot/nukebot_shadow.png",
      priority = "high",
      line_length = 32,
      width = 64,
      height = 51,
      ...
      --shift = {0.78125, 0},
      hr_version = {
        filename = "__Advanced-Atomics_Fixed__/graphics/entity/nukebot/hr-nukebot_shadow.png",
        priority = "high",
        line_length = 32,
        width = 128,
        height = 103,
...

  {
    ...
    variants =
    {
      ...
      material_background =
      {
        picture = "__Advanced-Atomics_Fixed__/graphics/entity/uranium-concrete.png",
        count = 8,
        hr_version =
        {
          picture = "__Advanced-Atomics_Fixed__/graphics/entity/hr-uranium-concrete.png",
          count = 8,
          scale = 0.5
        },
...

{
    type = "item",
    name = "uranium-concrete",
    icon = "__Advanced-Atomics_Fixed__/graphics/icons/uranium-concrete.png",
    icon_size = 32,
    flags = {},
    subgroup = "terrain",
