data:extend(
{
    ...
    spine_animation =
    {
      filename = "__Advanced-Atomics_Fixed__/graphics/entity/flamethrower-fire-stream/uranium-flamethrower-fire-stream-spine.png",
      blend_mode = "additive",
      line_length = 4,
      width = 32,
      height = 18,
    ...
    shadow =
    {
      filename = "__Advanced-Atomics_Fixed__/graphics/entity/flamethrower-fire-stream/uranium-flamethrower-explosion.png",
      line_length = 5,
      width = 28,
      height = 16,
      frame_count = 33,
	...
	--- Uranium Shells
	{
		...
		picture =
		{
			filename = "__Advanced-Atomics_Fixed__/graphics/entity/artillery-projectile/hr-uranium-shell.png",
			width = 64,
			height = 64,
			scale = 0.5,
		},
		...
		chart_picture =
		{
			filename = "__Advanced-Atomics_Fixed__/graphics/entity/artillery-projectile/uranium-artillery-shoot-map-visualization.png",
			flags = { "icon" },
			frame_count = 1,
			width = 64,
			height = 64,
...

	{
		...
		animation =
		{
		  filename = "__Advanced-Atomics_Fixed__/graphics/entity/grenade.png",
		  frame_count = 1,
		  width = 24,
		  height = 24,
		  priority = "high"
	...
	--- uranium-shotgun
	{
		...
		animation =
		{
		  filename = "__Advanced-Atomics_Fixed__/graphics/entity/uranium-bullet.png",
		  frame_count = 1,
		  width = 3,
		  height = 50,
		  priority = "high"
...
data:extend(
{
	--- Plutonium Projectile
	{
		...
		picture =
		{
			filename = "__Advanced-Atomics_Fixed__/graphics/entity/artillery-projectile/hr-plutonium-shell.png",
			width = 64,
			height = 64,
			scale = 0.5,
		},
		...
		chart_picture =
		{
			filename = "__Advanced-Atomics_Fixed__/graphics/entity/artillery-projectile/plutonium-artillery-shoot-map-visualization.png",
			flags = { "icon" },
			frame_count = 1,
			width = 64,
			height = 64,
...

	{
		...
		animation = {
		  layers = {
			{
			  filename = "__Advanced-Atomics_Fixed__/graphics/entity/nukebot-capsule.png",
			  flags = { "no-crop" },
			  frame_count = 1,
			  width = 48,
			  height = 36,
			...
			{
			  filename = "__Advanced-Atomics_Fixed__/graphics/entity/nukebot-capsule-mask.png",
			  flags = { "no-crop" },
			  frame_count = 1,
			  width = 48,
			  height = 36,
		...
		shadow =
		{
		  filename = "__Advanced-Atomics_Fixed__/graphics/entity/nukebot-capsule-shadow.png",
		  flags = { "no-crop" },
		  frame_count = 1,
		  width = 50,
		  height = 38,
		...
		--- Nade projectile
	{
		...
		picture =
		{
			filename = "__Advanced-Atomics_Fixed__/graphics/entity/artillery-projectile/hr-nadeshow-shell.png",
			width = 64,
			height = 64,
			scale = 0.5,
		},
