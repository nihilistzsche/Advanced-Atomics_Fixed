data:extend(
{
    ...
    type = "item",
    name = "plutonium-239",
    icon = "__Advanced-Atomics_Fixed__/graphics/icons/plutonium-239.png",
    icon_size = 32,
    flags = {},
    ...
    icon = "__Advanced-Atomics_Fixed__/graphics/icons/plutonium-processing.png",
    icon_size = 32,
    subgroup = "intermediate-product",
  ...
  -- Plutonium fuel
  {
    type = "item",
    name = "plutonium-fuel",
    icon = "__Advanced-Atomics_Fixed__/graphics/icons/plutonium-fuel.png",
    icon_size = 32,
    flags = {},
...
--- mox-fuel-cell
  {
    type = "item",
    name = "mox-fuel-cell",
    icon = "__Advanced-Atomics_Fixed__/graphics/icons/mox-fuel-cell.png",
    icon_size = 32,
    flags = {},
    subgroup = "intermediate-product",
