data:extend(
{
	--- Uranium Armor
	{
		...
		name = "uranium-armor",
		icon_size = 128,
		icon = "__Advanced-Atomics_Fixed__/graphics/technology/uranium-armor_128.png",
		effects = {
			{
				type = "unlock-recipe",
...
data:extend(
{
	--- Plutonium
	{
		...
		name = "plutonium",
		icon_size = 128,
		icon = "__Advanced-Atomics_Fixed__/graphics/technology/plutonium_128.png",
		effects = {
			{
				type = "unlock-recipe",
...
--[[ 	---Plutonium warfare
	{
		...
		icon_size = 128,
		icon = "__Advanced-Atomics_Fixed__/graphics/technology/plutonium-warfare_128.png",
		effects = {
			{
				type = "unlock-recipe",
				recipe = "plutonium-armor"
	...
	{
		{
			...
			icon_size = 128,
			icon = "__Advanced-Atomics_Fixed__/graphics/technology/uranium-extraction_128.png",
			effects = {
				{
					type = "unlock-recipe",
