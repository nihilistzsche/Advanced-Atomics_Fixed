data:extend(
{
  ...
  icon = "__Advanced-Atomics_Fixed__/graphics/icons/uranium-shield.png",
  icon_size = 32,
  ...
  default_request_amount = 10
...

   {
    ...
    sprite =
    {
      filename = "__Advanced-Atomics_Fixed__/graphics/equipment/uranium-shield-equipment.png",
      width = 64,
      height = 64,
      priority = "medium"
    },
...
data:extend(
{
  --- Plutonium Shield
  {
    ...
    icon = "__Advanced-Atomics_Fixed__/graphics/icons/plutonium-shield.png",
    icon_size = 32,
    ...
    default_request_amount = 10
   },
     {
      ...
      sprite =
      {
        filename = "__Advanced-Atomics_Fixed__/graphics/equipment/plutonium-shield-equipment.png",
        width = 64,
        height = 64,
        priority = "medium"
      },
  ...
  --- Plutonium Battery
  {
    ...
    icon = "__Advanced-Atomics_Fixed__/graphics/icons/radionuclide-battery.png",
    icon_size = 32,
...

  {
    ...
    sprite =
    {
      filename = "__Advanced-Atomics_Fixed__/graphics/equipment/radionuclide-battery-equipment.png",
      width = 32,
      height = 64,
      priority = "medium"
    },
